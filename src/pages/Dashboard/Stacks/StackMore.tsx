  ...
  return (
    <div className="p-5">
      <div className="flex items-center justify-between">
        ...
        <div className="p-5 mb-10 flex flex-col border mt-5 border-slate-400 rounded-xl w-[50%]">
      <div className="flex items-center justify-between">
          <ul className=" flex flex-col gap-5  w-[60%]">
        ...
        <div className="w-full mt-2">
          <ul className="flex flex-col gap-5">
            <li className="flex flex-col">
              ...
              <strong className="mt-1">{data.description}</strong>
            </li>
          </ul>
        </div>
